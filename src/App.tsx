...
export default function App() {
  ...
  return (
    <div className="landing-page min-h-screen w-full flex flex-col items-center justify-center font-sans text-ink bg-surface/50 p-4 box-border">

        
      {/* RIGHT PANEL - AUTHENTICATION */}
      <div className="lg:w-[58%] flex flex-col justify-center h-full min-h-screen lg:overflow-y-auto">
        {/* Header */}
                  ...
                  <form onSubmit={handleLogin} className="bg-surface border border-line rounded-[4px] p-5 lg:p-6 lg:py-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="pt-2">
                        ...
                        {portal === 'patient' && (
                          <button type="button" onClick={handleDummyFingerprintLogin} disabled={authLoading} className="w-full h-[40px] mt-2 border border-primary text-primary rounded-[6px] text-[13px] font-medium hover:bg-primary/5 transition-colors flex items-center justify-center gap-2 disabled:opacity-60">
                        ...
                        <>
                          ...
                          <div className="rounded-md border border-line bg-app p-3">
                            <div className="flex items-center justify-between gap-3">
                              ...
                              <button type="button" onClick={() => { set('fingerprintEnrolled', 'true'); toast('Demo fingerprint enrolled for this prototype'); }} className={`px-3 py-2 rounded-md text-[12px] font-medium flex items-center gap-1.5 ${f.fingerprintEnrolled === 'true' ? 'bg-ok-bg text-ok' : 'bg-primary text-white'}`}>
...
function LandingPage({
  ...
  const benefits = [
    ...
    {
      number: '02',
      title: 'Voice-First, Inclusive Care',
      icon: <Headphones className="w-5 h-5" />,
      text: 'Patients can record their case by voice in 10 Indian languages, making healthcare easier to access, understand and communicate.',
    },
    {
      number: '03',
    ...
    {
      number: '04',
      title: 'QR Access During the Golden Hour',
      icon: <Activity className="w-5 h-5" />,
      text: 'A single QR scan puts critical details like blood group and allergies in a doctor’s hands during the Golden Hour.',
    },
    {
      number: '05',
  ...
  return (
    <div className="um-page relative min-h-screen overflow-x-hidden bg-[#020b0a] text-white selection:bg-emerald-300/30">
      <style>{`
        ...
        @keyframes um-pulse {
          0%, 100% { transform: scale(.65); opacity: .16; box-shadow: 0 0 0 0 rgba(52,211,153,.08); }
          50% { transform: scale(1.1); opacity: .8; box-shadow: 0 0 24px 4px rgba(52,211,153,.18); }
        }
        @keyframes um-float {
        ...
        .um-border::before {
          ...
          padding: 1px;
          background: linear-gradient(120deg, rgba(110,231,183,.48), rgba(255,255,255,.04), rgba(45,212,191,.3));
        ...
        .um-typing {
          ...
          overflow: hidden;
          white-space: nowrap;
          border-right: 1px solid rgba(110,231,183,.7);
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        {dots.map((_, i) => (
          <span
            key={i}
            className="um-dot absolute h-[2px] w-[2px] rounded-full bg-emerald-200/70"
            style={{
              left: `${(i * 37) % 101}%`,
              top: `${(i * 61 + 7) % 94}%`,
              ...
              <div className="um-glass um-border relative overflow-hidden rounded-[34px] p-3 shadow-[0_40px_120px_rgba(0,0,0,.45)]">
                <div className="relative overflow-hidden rounded-[27px] border border-white/10 bg-[#071613]">
                  <img
                    ...
                    className="h-[460px] w-full object-cover opacity-75 sm:h-[540px]"
                  />
                  ...
                  <div className="absolute bottom-5 left-5 right-5 grid grid-cols-2 gap-3 sm:grid-cols-3">
                    {[
                      ...
                      <div key={label} className="um-glass rounded-2xl p-3.5">
                        <p className="text-[9px] uppercase tracking-[.16em] text-white/40">{label}</p>
        ...
        <section id="about" className="mx-auto max-w-[1320px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
          <div className="um-glass um-border grid overflow-hidden rounded-[32px] lg:grid-cols-[.9fr_1.1fr]">
            ...
            <div className="relative min-h-[330px] overflow-hidden border-t border-white/10 lg:min-h-[500px] lg:border-l lg:border-t-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[#071613] via-transparent to-[#071613]/20" />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(52,211,153,.14),transparent_45%)]" />
              <div className="absolute bottom-6 left-6 rounded-2xl border border-white/10 bg-[#020b0a]/65 px-4 py-3 backdrop-blur-xl sm:left-8 sm:bottom-8">
                <p className="text-[9px] uppercase tracking-[.2em] text-white/40">Designed for continuity</p>
                <p className="mt-1 text-sm font-semibold text-white">Your care. Connected.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="benefits" className="mx-auto max-w-[1320px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
          <div className="mb-10">
            ...
            <p className="mt-5 max-w-4xl text-sm leading-7 text-white/50 sm:text-base">
              United Medication in Cooperation gives every patient a lifelong digital health identity — register once, and your medical history, prescriptions and reports follow you to any hospital. Patients can record their case by voice in 10 Indian languages, while doctors verify records in seconds. A single QR scan puts critical details like blood group and allergies in a doctor's hands during the Golden Hour. With 5 connected portals synced in real time on a secure, paperless cloud platform, healthcare becomes connected, inclusive and instant.
            </p>
          </div>
