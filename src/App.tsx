...
export default function App() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (portal === 'caretaker' && (!f.name?.trim() || !f.patientHealthId?.trim() || !hasLocation(f.state) || !hasLocation(f.district))) { setAuthError('Name, patient Health ID, state and district are required.'); return; }
