...
export default function App() {
  ...
  if (loggedIn) {
    const Dashboard =
      loggedIn === 'patient' ? PatientDashboard : loggedIn === 'doctor' ? DoctorDashboard : AdminDashboard;
    return (
                    ...
                    <div className="space-y-3">
                      {portal === 'patient' && (
                        <>
                          ...
                          <FieldWithMic label="Allergies" textarea placeholder="e.g. Penicillin (medicine), Dust (other)" value={f.allergies || ''} onChange={(v) => set('allergies', v)} />
