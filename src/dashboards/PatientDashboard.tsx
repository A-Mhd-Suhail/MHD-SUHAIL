...
import {
  ...
  Loader2, Home, ArrowLeft, RefreshCw, HeartHandshake, Search, Command, ChevronRight, Menu, X,
} from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 custom-scrollbar space-y-1">
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-[13px] font-bold text-danger bg-danger-bg/20 hover:bg-danger-bg/40 transition-colors border border-danger-bd/30"
          >
