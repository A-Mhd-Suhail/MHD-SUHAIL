  ...
  return (
    <div className="max-w-[1000px] mx-auto space-y-6 pb-12">
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        ...
        <div className="bg-[#52657d] text-white border-l-4 border-[#d9c48b] rounded-[10px] p-5 shadow-sm">
          ...
          {nextAppt ? (
            <>
              ...
              <button onClick={() => go(t('appts'))} className="mt-3 text-[13px] font-medium text-white hover:underline">{t('viewDetails')}</button>
            </>
          ) : (
            <>
              <p className="text-[13px] text-white/80">{t('noUpcomingAppts')}</p>
              <button onClick={() => go(t('appts'))} className="mt-3 text-[13px] font-medium text-white hover:underline">{t('bookAppt')} →</button>
            </>
          )}
          {dueFollowups.length > 0 && (
            <div className="mt-3 text-[12px] text-[#fff8df] bg-[#7d765d] border border-[#b3a977] rounded-[6px] p-2.5">
