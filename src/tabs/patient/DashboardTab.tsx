...
export default function DashboardTab({ me, go }: { me: MhdUser; go: (tab: string) => void }) {
  ...
  return (
    <div className="max-w-[1150px] mx-auto space-y-6 pb-12">
      ...
      <div className="bg-gradient-to-r from-[#eaf3ff] via-[#dfeeff] to-[#edf5ff] border border-[#b8d7ff] rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
        <div className="flex items-center gap-3.5">
          <div className="p-3 rounded-2xl bg-white border border-[#b8d7ff] text-[#2a8eff] shadow-xs">
            <Sparkles className="w-6 h-6 animate-pulse" />
          </div>
          <div>
            <h3 className="text-sm font-bold text-[#2a8eff] flex items-center gap-2">
              AI Symptom & Care Assistant
            </h3>
            <p className="text-xs text-[#2a8eff] mt-0.5">
        ...
        <button
          onClick={() => go(t('mycase'))}
          className="px-3.5 py-2 bg-white hover:bg-[#eaf3ff] text-[#2a8eff] border border-[#b8d7ff] rounded-xl text-xs font-semibold transition-all flex items-center gap-1.5 shrink-0"
        >
          Open Assistant <ArrowRight className="w-3.5 h-3.5 text-[#2a8eff]" />
        </button>
      </div>
